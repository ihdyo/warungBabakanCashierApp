...
object RemoteData {
    ...
    const val FIELD_CREATED_AT = "__createdAt"
    const val FIELD_UPDATE_AT = "__updateAt"
    const val FIELD_DOCUMENT_ID = "___ID"
    const val FIELD_USER_ID = "_userId"
    const val FIELD_PRODUCT_ID = "_productId"
    const val FIELD_CATEGORY_ID = "_categoryId"
